  ...
  return (
    <div className="bg-grain relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      >
        ...
        <h1 className="font-display text-2xl font-medium text-warm">Set up your forge</h1>
        <p className="mt-1.5 text-sm text-ash">Create an account to start tracking leads.</p>
        ...
        <p className="mt-6 text-center text-sm text-ash">
          Already have one?{" "}
          <Link href="/login" className="text-forge hover:opacity-80">
            Sign in
          </Link>
        </p>
      </motion.div>
